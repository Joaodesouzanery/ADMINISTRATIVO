...
export const useFinancialStore = create<FinancialState>()(
  persist(
    (set) => ({
      transactions: { construdata: cdFin.transactions, iris: irisFin.transactions, padrao: [] },
      payroll: { construdata: cdFin.payroll, iris: irisFin.payroll, padrao: [] },
      okrs: { construdata: cdFin.okrs, iris: irisFin.okrs, padrao: [] },
