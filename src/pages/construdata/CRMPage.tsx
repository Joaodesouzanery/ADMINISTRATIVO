...
const stageBadge: Record<DealStage, 'default' | 'info' | 'warning' | 'success' | 'danger'> = { lead: 'default', qualified: 'info', proposal: 'warning', negotiation: 'navy' as 'default', won: 'success', lost: 'danger' }
